...
class Player:
    ...
    def draw(self):
        ...
        if self.isRunning is False and self.isAttacking is False:
            ...
            if self.vel.x > 0:
                self.game.screen.blit(self.game.sprite.img_player_idle, self.game.sprite.scale_image(self.pos.x - self.scroll.x, self.pos.y))
        ...
        if self.isRunning is True and self.isAttacking is False:
            if self.vel.x > 0:
                ...
                self.game.screen.blit(self.game.sprite.img_player_running_flip[self.runCount // 3], self.game.sprite.scale_image(self.pos.x - self.scroll.x, self.pos.y))
                self.runCount += 1
